...
public:
    ...
    :stop_words_(collection_stop_words.begin(), collection_stop_words.end())
    {}

    explicit SearchServer(const string& string_stop_words) : SearchServer(SplitIntoWords(string_stop_words)) 
    {}
